      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <header className="mb-12">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">Terms of Service</h1>
        ...
        <main className="prose dark:prose-invert prose-blue max-w-3xl mx-auto">
          <section className="mt-8">
            ...
            <p>
              Welcome to OSI Model Simulator. By accessing our website, you agree to these Terms of Service. 
          ...
          <section className="mt-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Limitations</h2>
            <p>
              In no event shall OSI Model Simulator or its suppliers be liable for any damages 
              ...
              OSI Model Simulator or an authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>
          </section>
          
          <section className="mt-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Accuracy of Materials</h2>
            <p>
              The materials appearing on the OSI Model Simulator website could include technical, typographical, or photographic errors. 
              OSI Model Simulator does not warrant that any of the materials on its website are accurate, complete, or current. 
              OSI Model Simulator may make changes to the materials contained on its website at any time without notice.
            </p>
          </section>
          
          <section className="mt-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Links</h2>
            <p>
          ...
          <section className="mt-8">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Modifications</h2>
            <p>
              OSI Model Simulator may revise these terms of service for its website at any time without notice. 
